<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="boardroombooking.aspx.cs" Inherits="_26onGrant.WebForm1" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>26 on Grant | Boardroom Booking</title>
    ...
    <script>
        function search() {
            $.ajax({
                type: "POST",
                url: 'boardroombooking.aspx/calendarData2',
...
<%--<script type="text/javascript" charset="utf-8">
		...
		function init() {
            ...
            scheduler.init('scheduler_here', new Date(2017, 11, 18), "day");
            scheduler.lxoad("Webform.aspx/calendarData", "json");

            var dp = new dataProcessor("data/events_json.php");
            dp.init(scheduler);
        }
</script>--%>
